      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                <li><a href="<?php echo base_url(); ?>">Usuários<span class="sr-only">(current)</span></a></li>
                <li class="active"><a href="<?php echo base_url(); ?>index.php/admin/add">Adicionar usuários</a></li>
              </ul>
          </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
    </nav>    
      ...
      <div class="row">
        ...
        <form action="<?php echo base_url(); ?>index.php/admin/salvar" name="form_add" method="post">
          ...
          <div class="row">
            <div class="col-md-8">
              <label>CPF:</label>
              <input type="text" name="cpf" value="" class="form-control" required>
            </div>
          </div><!-- fim input text -->
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <input type="date" name="data_nascimento" value="" class="form-control" required>
            </div>
          </div><!-- fim input date -->
